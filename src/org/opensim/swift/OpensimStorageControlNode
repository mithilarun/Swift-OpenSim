...
public class OpensimStorageControlNode {
	...
	//double dbContainerAccessTime=		//in sec
	//double dbContainerCreationTime=		//in sec
	private void initControlNode() throws ParameterException
	{
		...
		//db0.setContainerAccessTime(dbContainerAccessTime);
		//db0.setContainerCreationTime(dbContainerCreationTime);
		...
		Log.printLine("Container Access time : " +db0.getContainerAccessTime());
		Log.printLine("Container Creation time: " +db0.getContainerCreationTime());
		...
		//db1.setContainerAccessTime(dbContainerAccessTime);
		//db1.setContainerCreationTime(dbContainerCreationTime);
		...
		Log.printLine("Container Access time : " +db1.getContainerAccessTime());
		Log.printLine("Container Creation time: " +db1.getContainerCreationTime());
