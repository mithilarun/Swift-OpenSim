...
public class OpensimStorageServer implements Storage{
	...
	/**Time to find existing container. */
	private double containerAccessTime;
	
	/**Time to create a new container. */
	private double containerCreationTime;
	
	/**Time to access file from a container. */
	private double objectAccessTime;
	
	/**Time to upload file to a container. */
	private double objectUploadTime;
 ...
 */
	...
	/**
	 * Sets the container access time of this harddrive in seconds.
	 * 
	 * @param containerAccessTime the new container access time in seconds
	 * @return <tt>true</tt> if the setting succeeded, <tt>false</tt> otherwise
	 */
	
	public boolean setContainerAccessTime(double containerAccessTime) {
		if (containerAccessTime < 0) {
			return false;
		}

		this.containerAccessTime = containerAccessTime;
		return true;
	}

	/**
	 * Gets the container access time of this harddrive in seconds.
	 * 
	 * @return the container access time in seconds
	 */
	public double getContainerAccessTime() {
		return containerAccessTime;
	}

	/**
	 * Sets the container creation time of this harddrive in seconds.
	 * 
	 * @param containerCreationTime the new container creation time in seconds
	 * @return <tt>true</tt> if the setting succeeded, <tt>false</tt> otherwise
	 */
	
	public boolean setContainerCreationTime(double containerCreationTime) {
		if (containerCreationTime < 0) {
			return false;
		}
	...
	/**
	 * Gets the container creation time of this harddrive in seconds.
	 * 
	 * @return the container creation time in seconds
	 */
	public double getContainerCreationTime() {
		return containerCreationTime;
	}
	
	/**
	 * Sets the object access time of this harddrive in seconds.
	 * 
	 * @param objectAccessTime the new container access time in seconds
	 * @return <tt>true</tt> if the setting succeeded, <tt>false</tt> otherwise
	 */
	
	public boolean setObjectAccessTime(double objectAccessTime) {
		if (objectAccessTime < 0) {
			return false;
		}

		this.objectAccessTime = objectAccessTime;
		return true;
	}

	/**
	 * Gets the object access time of this harddrive in seconds.
	 * 
	 * @return the object access time in seconds
	 */
	public double getObjectAccessTime() {
		return objectAccessTime;
	}
	...
	public boolean setObjectUploadTime(double objectUploadTime) {
		if (objectUploadTime < 0) {
			return false;
		}

		this.objectUploadTime = objectUploadTime;
		return true;
	}

	/**
	 * Gets the object upload time of this harddrive in seconds.
	 * 
	 * @return the object upload time in seconds
	 */
	public double getObjectUploadTime() {
		return objectUploadTime;
	}
	...
	public File getFile(String fileName) {
		...
		if (found) {
			...
			obj.setTransactionTime(seekTime + transferTime + containerTime);
		}
	...
	public double addFile(File file) {
		...
		if (!contains(file.getName())) {
			...
			result = seekTime + transferTime + containerTime ;  // add total time
		}
