...
public class Vm {
	...
	public int getCurrentRequestedRam() {
		//System.out.println("Inside getCurrentRequestedRam");
		if (isBeingInstantiated()) {
			return getRam();
		}
	...
	public double getTotalIOPS(double time) {
		System.out.println("-----IOPS--- " + getCloudletScheduler().getTotalIOPS(time));
		return getCloudletScheduler().getTotalIOPS(time);
	}
