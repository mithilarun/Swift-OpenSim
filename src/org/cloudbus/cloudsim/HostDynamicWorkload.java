...
public class HostDynamicWorkload extends Host {
	...
	public double updateVmsProcessing(double currentTime) {
		...
		for (Vm vm : getVmList()) {
			...
			double totalIOPS=vm.getTotalIOPS(currentTime);
			...
			if (!Log.isDisabled()) {
				...
				Log.formatLine("%.2f: ---IOPS:  %.2f for host #"+getId() + " " ,CloudSim.clock(), totalIOPS);
			...
			hostTotalIOPS+=totalIOPS;
		}
		//Log.formatLine("%.2f: ---IOPS:  %.2f for host #"+getId() + " " ,CloudSim.clock(), hostTotalIOPS/2);
	...
	/**
	 * Sets the utilization iops.
	 * 
	 * @param utilizationMips the new utilization iops
	 */
	protected void setUtilizationIOPS(double utilizationIOPS) {
	...
	/**
	 * Gets the previous utilization Iops.
	 * 
	 * @return the previous utilization iops
	 */
	...
	/**
	 * Sets the previous utilization iops.
	 * 
	 * @param previousUtilizationMips the new previous utilization iops
	 */
	protected void setPreviousUtilizationIOPS(double previousUtilizationIOPS) {
