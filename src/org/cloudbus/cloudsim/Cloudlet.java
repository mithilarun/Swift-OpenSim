...
public class Cloudlet {
	...
	public double getUtilizationOfCpu(final double time) {
		//System.out.println("Utili= "+getUtilizationModelCpu().getUtilization(time)+"------------- "+"TIME= "+time);
		//Log.printLine("Inside getUtilizationOfCPu------------- "+getUtilizationModelCpu().getUtilization(time));
	...
	public double getUtilizationOfRam(final double time) {
		//System.out.println("Inside getUtilizationOfRam ------------- ");
		System.out.println("iops= "+ getUtilizationModelRam().getUtilization(time));
		return getUtilizationModelRam().getUtilization(time);
	}
