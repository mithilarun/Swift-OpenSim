...
public class PowerVm extends Vm {
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		//Log.printLine("Inside PowerVm update VmProcessing");
		...
		if (currentTime > getPreviousTime() && (currentTime - 0.1) % getSchedulingInterval() == 0) {
			...
			double iops=getTotalIOPS(getCloudletScheduler().getPreviousTime());
			//Log.printLine("UITL of POWER VM  = "+utilization + " -----");
